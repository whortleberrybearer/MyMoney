...
- [x] 2.2 Write unit tests in `tests/unit/CategoryCombobox.test.tsx` covering: renders all categories, typing filters list (case-insensitive), selecting a category fires onChange, Uncategorised is always present, pre-selects current value
